defmodule Tranca.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Tranca.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    TrancaWeb.Endpoint.config_change(changed, removed)
    :ok
  end
